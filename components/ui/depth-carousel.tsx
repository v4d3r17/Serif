...
export default function DepthCarousel({
  ...
  const onCardClick = useCallback(
    (index: number) => {
      ...
      // If clicking the already active card, navigate if href is provided
      if (active === index && data[index]?.href) {
        window.location.href = data[index].href;
        return;
      }
      
      setFocus(index, true);
    },
    [setFocus, active, data]
  );
