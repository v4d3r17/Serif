  ...
  return (
    <div className="flex flex-col gap-8 max-w-5xl mx-auto w-full pb-10">
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <div className="rounded-xl border bg-card/60 backdrop-blur-md text-card-foreground shadow p-6 flex flex-col justify-between">
          ...
          <div className="flex flex-col gap-4">
            {recentBlogs.map((blog) => (
              <Link 
                ...
                key={blog.id}
                className="flex flex-col sm:flex-row sm:items-center justify-between rounded-xl border bg-background/50 p-5 hover:bg-muted/50 transition-colors gap-4 group cursor-pointer"
              >
                <div className="flex flex-col gap-1">
